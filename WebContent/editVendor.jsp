...
String pageNo=request.getParameter("vendor_page_count");
...
try
{
	...
	v=db.getVendor(vendorid);
	if(v.getStatus()<=0)
	{
		session.setAttribute("errorViewVendor","<b><center><font color='red'>Vendor Not Found</font></center></b>");
		response.sendRedirect("viewVendors.jsp?vendor_page_count="+pageNo);
	}
}
catch(Exception e)
					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
								<form action="updateVendor.jsp" method="POST"
									class='form-horizontal form-validate' id="bb">
									<div class="control-group">
										<label for="textfield" class="control-label">Login
											User Name</label>
										<div class="controls">
										<input type="hidden" name="vendor_id" value="<%=v.getId() %>">
											<input type="text"  name="vendor_username" id="textfield"
												class="input-xlarge" data-rule-required="true" value="<%=v.getLogin_name() %>"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="password" name="vendor_password" id="pwfield"
												class="input-xlarge" data-rule-required="true"  value="<%=v.getPassword() %>">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Vendor
											Name</label>
										<div class="controls">
											<input type="text" name="vendor_name" id="textfield"
												class="input-xlarge" data-rule-required="true"  value="<%=v.getName() %>"
												data-rule-minlength="5">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Vendor
											Short Name</label>
										<div class="controls">
											<input type="text" name="vendor_short_name" id="textfield"
												class="input-xlarge" data-rule-required="true" value="<%=v.getShort_name() %>"
									...
									<div class="control-group">
										<label for="textfield" class="control-label">Vendor
											Tag Name</label>
										<div class="controls">
											<input type="text" name="vendor_tag_name" id="textfield"
												class="input-xlarge" data-rule-required="true" value="<%=v.getTag() %>"
												data-rule-minlength="2">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Vendor
											Description</label>
										<div class="controls">
											<TEXTAREA name='vendor_description' class="input-xlarge"
												data-rule-required="true"><%=v.getDescription() %></TEXTAREA>
										</div>
									</div>
									<div class="control-group">
										<label for="emailfield" class="control-label">Website
										</label>
										<div class="controls">
											<input type="text" name="vendor_website" class="input-xlarge" value="<%=v.getWebsite() %>"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_email" id="emailfield" value="<%=v.getEmail() %>"
												class="input-xlarge" data-rule-email="true"
												data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										<label for="emailfield" class="control-label">Logo Url</label>
										<div class="controls">
											<input type="text" name="vendor_logo" class="input-xlarge" value="<%=v.getLogo_url() %>"
												data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_phone" class="input-xlarge" value="<%=v.getPhone_no() %>"
												data-rule-required="true">
											<input type="hidden" name="vendor_page_count" value="<%=pageNo %>"
												>
										</div>
									</div>
								...
								<div>
									<%
										...
										session.setAttribute("errorVendor", "");
									%>
								</div>
							</div>
						</div>
