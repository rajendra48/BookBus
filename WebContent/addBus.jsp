					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
								<form action="storeBus.jsp" method="POST"
									class='form-horizontal form-validate' id="bb">
									<div class="control-group">
										<label for="textfield" class="control-label">Bus Name/No</label>
										<div class="controls">
											<input type="text" name="bus_name" id="textfield"
									...
									<div class="control-group">
										<label for="emailfield" class="control-label">Minimum
											Fare</label>
										<div class="controls">
											<input type="text" name="minimum_fare" class="input-xlarge"
												data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										<label for="emailfield" class="control-label">Type of
											Bus </label>
										<div class="controls">
											<select name='bus_type'>
												<option value='A/C Sleeper'>A/C Sleeper</option>
												<option value='Non A/C Sleeper'>Non A/C Sleeper</option>
												<option value='A/C Semi Sleeper'>A/C Semi Sleeper</option>
												<option value='Non A/C Semi Sleeper'>Non A/C Semi
													Sleeper</option>
												<option value='A/C Bus'>A/C Bus</option>
												<option value='Non A/C Bus'>Non A/C Bus</option>
											</select>
										</div>
									</div>

									<div class="control-group">
										<label for="emailfield" class="control-label">Bus
											Capacity</label>
										<div class="controls">
											<input type="text" name="bus_capacity" id="bus_capacity"
												class="input-xlarge" data-rule-number="true"
												data-rule-required="true">
										</div>
									</div>
							</div>
