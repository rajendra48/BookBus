					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content">
								<form action="storeVendor.jsp" method="POST"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_website" class="input-xlarge"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_email" id="emailfield"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_logo" class="input-xlarge"
												data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="vendor_phone" class="input-xlarge"
												data-rule-required="true">
										</div>
									</div>
